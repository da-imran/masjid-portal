...
const SejarahMasjidPage: React.FC = () => {
    return (
        <div className="row">
            <div className="col">
                <h6 className="text mt-3" style={{ fontSize: '20px' }}><b>Sejarah Masjid</b></h6>
                <div className="mt-5 mb-5">
                    <p> Masjid ini dibina pada .... Dan ia mula digunakan dengan rasminya pada ...</p>
                    <p>Pada asalnya, masjid ini bernama Masjid Jamek Sungai Tiram. Pada masa ia diasaskan, masjid ini dikelilingi oleh sebuah kampung, dengan lorong - lorong kecil
                    ...
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Pintu Gerbang</i></b></h6>
                        <p> Informasi 1</p>
                    </div>
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Menara</i></b></h6>
                        <p> Informasi 2</p>
                    </div>
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Kubah Utama</i></b></h6>
                        <p> Informasi 3</p>
                    </div>
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Mimbar Masjid</i></b></h6>
                        <p> Informasi 4</p>
                    </div>
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Aras Satu</i></b></h6>
                        <p> Informasi 5</p>
                    </div>
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Aras Bawah</i></b></h6>
                        <p> Informasi 6</p>
                    </div>
                    <div className="mt-5">
                        <h6 className="text" style={{ fontSize: '15px' }}><b><i>Tarikan Pelancong</i></b></h6>
                        <p> Informasi 7</p>
                    </div>
                </div>
            </div>
...
export default SejarahMasjidPage;
